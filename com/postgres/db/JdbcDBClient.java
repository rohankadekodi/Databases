...
public final class JdbcDBClient {
	...
	public static int insert(int key, String filler) {
		...
		try {			
			...
			for (i = 1; i <= JdbcDBConstants.NUM_COLS; i++) {
				insertStatement.setString(1+i, filler);
			}
	...
	public static void main(String[] args) {
		...
		for (i = 0; i < JdbcDBConstants.FILLER_SIZE; i++) {
			fillerSB.append("A");
		}
